...
int main()
{
    ...
    cout << "Test basic empty initialisation\n";
    ...
    cout << "Test for Dracula trail and basic functions\n";
    string messages2[] = {"Hello","Rubbish","Stuff","","Mwahahah"};
    ...
    cout << "Test for encountering Dracula and hunter history\n";
    ...
    cout << "Test for Dracula doubling back at sea, and losing blood points (Hunter View)\n";
    PlayerMessage messages4[] = {"Hello","Rubbish","Stuff","","Mwahahah","Aha!","","","","Back I go"};
    gv = newGameView("GGE.... SGE.... HGE.... MGE.... DS?.... GST.... SST.... HST.... MST.... DD1.... ", messages4);
    ...
    cout << "Test for Dracula doubling back at sea, and losing blood points (Drac View)\n";
    PlayerMessage messages5[] = {"Hello","Rubbish","Stuff","","Mwahahah","Aha!","","","","Back I go"};
    gv = newGameView("GGE.... SGE.... HGE.... MGE.... DEC.... GST.... SST.... HST.... MST.... DD1.... ", messages5);
    assert(getLocation(gv,PLAYER_DRACULA) == DOUBLE_BACK_1);
    getHistory(gv,PLAYER_DRACULA,history);
    assert(history[0] == DOUBLE_BACK_1);
    ...
    cout << "Test for connections\n";
    int size, seen[NUM_MAP_LOCATIONS], *edges;
    gv = newGameView("", messages1);
    cout << "Checking Galatz road connections\n";
    ...
    cout << "Checking Ionian Sea sea connections\n";
    ...
    cout << "Checking Athens rail connections (none)\n";
    ...
    cout << "Checking Saragossa rail connections\n";
    edges = connectedLocations(gv,&size,SARAGOSSA,PLAYER_LORD_GODALMING,3,1,1,0);
    memset(seen, 0, NUM_MAP_LOCATIONS*sizeof(int));
    for (i = 0; i < size; i++) {
        seen[edges[i]] = 1;
    }
    assert(size == 12); assert(seen[BARCELONA]); assert(seen[ALICANTE]);
    assert(seen[MADRID]); assert(seen[BORDEAUX]); assert(seen[MARSEILLES]); assert(seen[TOULOUSE]);
    assert(seen[SANTANDER]); assert(seen[LE_HAVRE]); assert(seen[BRUSSELS]);
